 ...
 if ($cookie>0 || $user_company>0) {
           ...
           // echo $id_company;
            ...
            if ($id_company >0) {
                                   ...
                                   //если юзер - председатель этого ТСЖ
                                    else if ($user_company == $id_company)
                                    {
                                          ...
                                          //нажали кнопку сохранить
                                                ...
                                                //echo 'update company set tarif = "'.$_POST['tarif'].'" where id='.$id_company;
                                                $r1 = new Select($db,'update company set pre_tarif = "'.$_POST['pre_tarif'].'",pabl=0 where id='.$id_company);
                        ...
                        if ($r1->next_row()) {
                                     $r1->addFieldHTML($main,'pre_tarif');
                                     $r1->addFieldHTML($main,'tarif');
                        };
            }
            else
