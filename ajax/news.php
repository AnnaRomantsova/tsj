...
*/
   ...
   $sql1="select count(id) as cnt from news where pabl=1 and ntype=1 ";
   $r1 = new Select($db,$sql1);
   $r1->next_row();
  ...
  // var_dump($_POST);
   ...
   $sql['sql']="select * from news where pabl=1 and ntype=1  order by datetime desc,ntype limit 0,$from";
